...
public FlagOption binarySplitsOption = FlagOption.createFlagOption(new FlagOptionParameter("binarySplits", 'b', "Only allow binary splits."));
    ...
    public FlagOption stopMemManagementOption = FlagOption.createFlagOption(new FlagOptionParameter("stopMemManagement", 'z', "Stop growing as soon as memory limit is hit."));
